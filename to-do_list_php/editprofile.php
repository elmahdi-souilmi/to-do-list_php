...
if (array_filter($errors)) {
    ...
    $user1 -> UpdateInformation($username, $email, $firstname, $lastname, $photo, $passwordd, $id);
...
<!-- Default form login -->
<div class="container">
<form class="text-center border border-light p-5 z-depth-2 mx-auto formsm" action="editprofile.php" method="POST">
    <h2 class="h1 mb-4">UPDATE YOUR INFORMATION</h2>
    ...
    <div >
            ...
            <p class="error"> <?php echo $errors['photo'] ?> </p>
        </div>
    <!-- E-mail -->
    ...
    <!-- Password -->
    <input type="password" id="defaultRegisterFormPassword" name="password" value="<?php echo $password ?>" class="form-control" placeholder="Password" aria-describedby="defaultRegisterFormPasswordHelpBlock">
    <h5 class="error"> <?php echo $errors['password'] ?> </h5>
    <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4">
        At least 8 characters and 1 digit
    </small>
    <!-- Sign up button -->
    <button class="btn btn-info my-4 btn-block" name="submit" type="submit">update</button>
    <hr>
    <!-- Terms of service -->
    <p>By clicking
